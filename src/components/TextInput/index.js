            ...
            <div className='text_input'>
                <div className='text_input-border'>
                    ...
                    <div className={`text_input--label-wrapper--${labelState} ${borderStylePrefix}${state}`}>
                        <label className={`text_input--floating-label-${labelState}`}>Name</label>
                    </div>
                    <div className={`text_input--label-wrapper-trailing ${borderStylePrefix}${state}`}></div>
                </div>
                <input value={this.props.value} onFocus={this.onFocus} onBlur={this.onBlur} type='text' name='text' onChange={this.handleChange} className='text_input--input'/>
